...
if os.path.exists( "..\\CTR\\history\\pops\\1861.4.1" ):
    print( "Removing 1861 starting pops..." )
    shutil.rmtree( "..\\CTR\\history\\pops\\1861.4.1" )
    print( "    Complete!" )

if os.path.exists( "..\\CTR\\history\\units\\1861" ):
    print( "Removing 1861 starting units..." )
